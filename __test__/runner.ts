...
import { build, execute } from '@velcro/runner';
...
describe('Velcro.runner', () => {
  ...
  it('will bundle github-markdown-css css code', async () => {
    const code = `
    ...
    expect(output.code).toMatchInlineSnapshot(`
      ...
      },{\\"scopes\\":{\\"https://cdn.jsdelivr.net/npm/github-markdown-css@4.0.0/github-markdown.css\\":{}}}];
      })(Velcro.registry);

      Velcro.runtime = function createRuntime(velcro) {
          class Module {
              /**
